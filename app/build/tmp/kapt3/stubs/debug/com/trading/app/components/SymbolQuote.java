...
public final class SymbolQuote {
    ...
    java.lang.String name, float lastPrice, float change, float changePercent, float open, float high, float low, float prevClose, float bid, float ask, float volume, float spread) {
        super();
    }
